      ...
      inject: {
        importMap: {
          imports: {
            ...
            'react-native-web': 'https://esm.sh/react-native-web@0.21.2?dev&external=react,react-dom',
            'react-native': 'https://esm.sh/react-native-web@0.21.2?dev&external=react,react-dom',
          },
        },
      },
    }),
